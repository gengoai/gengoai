...
//   public static final PartOfSpeech VNV = PartOfSpeech.create("VNV", "VNV", PartOfSpeech.ADVERB, true);
   ...
   public static final PartOfSpeech AS = PartOfSpeech.create("AS", "AS", PartOfSpeech.OTHER, false);
   ...
   public static final PartOfSpeech DEG	 = PartOfSpeech.create("DEG", "DEG", PartOfSpeech.OTHER, false);
   public static final PartOfSpeech DER = PartOfSpeech.create("DER", "DER", PartOfSpeech.OTHER, false);
   public static final PartOfSpeech DEV = PartOfSpeech.create("DEV", "DEV", PartOfSpeech.OTHER, false);
   public static final PartOfSpeech ETC = PartOfSpeech.create("ETC", "ETC", PartOfSpeech.OTHER, false);
   ...
   public static final PartOfSpeech LC = PartOfSpeech.create("LC", "LC", PartOfSpeech.OTHER, false);
   public static final PartOfSpeech M = PartOfSpeech.create("M", "M", PartOfSpeech.OTHER, false);
   public static final PartOfSpeech MSP = PartOfSpeech.create("MSP", "MSP", PartOfSpeech.OTHER, false);
   ...
   public static final PartOfSpeech OD = PartOfSpeech.create("OD", "OD", PartOfSpeech.ADPOSITION, false);
