 ...
 */
public class IntegerFieldProcessor extends BaseStoreOptionalFieldProcessor {
   private static final long serialVersionUID = 1L;

   public IntegerFieldProcessor(String fieldName, boolean stored) {
   ...
   public void singleValue(@NonNull Document document, @NonNull Object value) {
      ...
      document.add(new IntPoint(getFieldName(), number));
      if (isStored()) {
