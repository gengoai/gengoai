 ...
 */
@NoArgsConstructor
public class StringFieldProcessor extends BaseStoreOptionalFieldProcessor {
   private static final long serialVersionUID = 1L;

   public StringFieldProcessor(String fieldName, boolean isStored) {
   ...
   public void singleValue(@NonNull Document document, @NonNull Object value) {
      ...
      document.add(new StringField(getFieldName(), str, isStored() ? Field.Store.YES : Field.Store.NO));
   }
