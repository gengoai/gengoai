...
public class Tuple3Test {
  ...
  public void array() throws Exception {
    assertArrayEquals(new Object[]{"A", "A", "A"}, tuple.array());
  }

  @Test
  public void mapValues() throws Exception {
    assertEquals(Tuples.$("a", "a", "a"), tuple.mapValues(o -> o.toString().toLowerCase()));
  }

  @Test
  public void shiftLeft() throws Exception {
    assertEquals(Tuples.$("A", "A"), tuple.shiftLeft());
  }

  @Test
  public void shiftRight() throws Exception {
    assertEquals(Tuples.$("A", "A"), tuple.shiftRight());
  }

  @Test
  public void appendRight() throws Exception {
    assertEquals(Tuples.$("A", "A", "A", "A"), tuple.appendRight("A"));
  }

  @Test
  public void appendLeft() throws Exception {
    assertEquals(Tuples.$("A", "A", "A", "A"), tuple.appendLeft("A"));
  }
  ...
  public void list() throws Exception {
    assertTrue(Tuples.$(Arrays.asList("A", "A", "A")) instanceof Tuple3);
  }
