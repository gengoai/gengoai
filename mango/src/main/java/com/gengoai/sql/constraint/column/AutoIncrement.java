...
/**
 * Constraint to auto increment the value of a column
 */
public class AutoIncrement implements ColumnConstraint {
   private static final long serialVersionUID = 1L;
   public static final AutoIncrement INSTANCE = new AutoIncrement();
