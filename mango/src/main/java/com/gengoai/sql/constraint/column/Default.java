...
public class Default extends Constraint implements ColumnConstraint {
   private static final long serialVersionUID = 1L;
   SQLElement expression;

   public Default(String name, @NonNull SQLElement expression) {
      super(name);
   ...
   public String toSQL(@NonNull SQLDialect dialect) {
      return super.toSQL(dialect) + "DEFAULT ( " + dialect.toSQL(expression) + " )";
   }
