...
public class SQLPrefixUnaryOperator extends SQLOperator {
    ...
    */
   public SQLPrefixUnaryOperator(String operator, @NonNull SQLElement arg1, boolean requiresParenthesis) {
      super(operator);
      this.arg1 = arg1;
   ...
   public String toSQL(@NonNull SQLDialect dialect) {
      if(isRequiresParenthesis()) {
         return dialect.translateOperator(getOperator()) + toSQL(dialect, arg1);
      }
      return dialect.translateOperator(getOperator()) + " " + toSQL(dialect, arg1);
   }
