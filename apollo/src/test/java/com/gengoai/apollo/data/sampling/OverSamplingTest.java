...
public class OverSamplingTest {
   ...
   public void sample() {
      ...
      OverSampling underSampling = new OverSampling(Datum.DEFAULT_OUTPUT);
      ...
      assertEquals(20L, counts.get("ALPHA"), 1);
      assertEquals(20L, counts.get("BETA"), 1);
   }
