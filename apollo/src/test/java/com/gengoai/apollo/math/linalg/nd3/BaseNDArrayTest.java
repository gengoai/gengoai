...
public abstract class BaseNDArrayTest {
   protected final NDArray<? extends Number> scalar;
   protected final NDArray<? extends Number> rowVector;
   protected final NDArray<? extends Number> colVector;
   protected final NDArray<? extends Number> matrix34;
   protected final NDArray<? extends Number> matrix43;
   protected final NDArray<? extends Number> tensor243;
   protected final NDArray<? extends Number> tensor234;
   protected final NDArray<? extends Number> tensor2234;
   protected final NDArrayFactory<? extends Number> factory;

   public BaseNDArrayTest(NDArrayFactory<? extends Number> factory) {
   ...
   public void decode() {
      ...
      NDArray<?> n = factory.array(new double[][]{
            {10, 0, 0},
            {2, 6, 3},
            {4, 1, 5}
      });
   ...
   @Test
   public void map() {
      if (factory.getType() == Integer.class) {
         assertEquals(factory.arange(Shape.shape(3, 4), 2),
                      matrix34.map(i -> Cast.as(i.intValue() + 1)));
         assertEquals(factory.arange(Shape.shape(2, 2, 3, 4), 2),
                      tensor2234.map(i -> Cast.as(i.intValue() + 1)));
         NDArray<Integer> t = Cast.as(tensor2234);
         assertEquals(factory.arange(Shape.shape(2, 2, 3, 4), 2),
                      t.map(1, Operator::add));
         NDArray<Integer> t2 = Cast.as(tensor234);
         assertEquals(factory.arange(Shape.shape(2, 2, 3, 4), 2, 2)
                      ...
                      t.map(t2, Operator::add));
      }
      if (factory.getType() == Long.class) {
         assertEquals(factory.arange(Shape.shape(3, 4), 2),
                      matrix34.map(i -> Cast.as(i.longValue() + 1)));
         assertEquals(factory.arange(Shape.shape(2, 2, 3, 4), 2),
                      tensor2234.map(i -> Cast.as(i.longValue() + 1)));
         NDArray<Long> t = Cast.as(tensor2234);
         assertEquals(factory.arange(Shape.shape(2, 2, 3, 4), 2),
                      t.map(1L, Long::sum));
         NDArray<Long> t2 = Cast.as(tensor234);
         assertEquals(factory.arange(Shape.shape(2, 2, 3, 4), 2, 2)
                             .setSlice(1, 0, Cast.as(factory.arange(Shape.shape(3, 4), 26, 2)))
                             .setSlice(1, 1, Cast.as(factory.arange(Shape.shape(3, 4), 50, 2))),
                      t.map(t2, Operator::add));
      }
      if (factory.getType() == Float.class) {
         assertEquals(factory.arange(Shape.shape(3, 4), 2),
                      matrix34.map(i -> Cast.as(i.floatValue() + 1)));
         assertEquals(factory.arange(Shape.shape(2, 2, 3, 4), 2),
                      tensor2234.map(i -> Cast.as(i.floatValue() + 1)));
         NDArray<Float> t = Cast.as(tensor2234);
         assertEquals(factory.arange(Shape.shape(2, 2, 3, 4), 2),
                      t.map(1f, Float::sum));
         NDArray<Float> t2 = Cast.as(tensor234);
         assertEquals(factory.arange(Shape.shape(2, 2, 3, 4), 2, 2)
                             .setSlice(1, 0, Cast.as(factory.arange(Shape.shape(3, 4), 26, 2)))
                             .setSlice(1, 1, Cast.as(factory.arange(Shape.shape(3, 4), 50, 2))),
                      t.map(t2, Operator::add));
      }
      if (factory.getType() == Double.class) {
         assertEquals(factory.arange(Shape.shape(3, 4), 2),
                      matrix34.map(i -> Cast.as(i.doubleValue() + 1)));
         assertEquals(factory.arange(Shape.shape(2, 2, 3, 4), 2),
                      tensor2234.map(i -> Cast.as(i.doubleValue() + 1)));
         NDArray<Double> t = Cast.as(tensor2234);
         assertEquals(factory.arange(Shape.shape(2, 2, 3, 4), 2),
                      t.map(1d, Double::sum));
         NDArray<Double> t2 = Cast.as(tensor234);
         assertEquals(factory.arange(Shape.shape(2, 2, 3, 4), 2, 2)
                             .setSlice(1, 0, Cast.as(factory.arange(Shape.shape(3, 4), 26, 2)))
                             .setSlice(1, 1, Cast.as(factory.arange(Shape.shape(3, 4), 50, 2))),
                      t.map(t2, Operator::add));
   ...
   @Test
   public void pad() {
      NDArray<?> n = factory.zeros(2, 2, 3, 4);
