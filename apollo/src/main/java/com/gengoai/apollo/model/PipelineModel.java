...
import com.gengoai.apollo.data.transform.MultiInputTransform;
 ...
 * a classifier would have its output NDArray transformed into a {@link com.gengoai.apollo.data.observation.Classification}
 * and a sequence labeler would have its output translated into a {@link com.gengoai.apollo.data.observation.VariableSequence}.
 * </p>
 * <p>
...
public class PipelineModel implements Model {
    ...
    private DataSet pipeline(DataSet dataset) {
        ...
        dataset.putAllMetadata(transformer.getMetadata());
        return dataset;
    }
