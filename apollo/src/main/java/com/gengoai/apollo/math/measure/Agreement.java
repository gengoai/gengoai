...
/**
 * <p>Common measures of Agreement.</p>
 *
 * @author David B. Bracewell
 */
public enum Agreement implements ContingencyTableCalculator {
   /**
    * <p><a href="https://en.wikipedia.org/wiki/Cohen%27s_kappa">Cohen's kappa</a> is a statistic to measure the
    * inter-annotator reliability.</p>
    */
   Cohen_Kappa {
      @Override
